...
DEST_DIR="/mnt/vault/backup/cache"                            # Destination directory (contains dated backup subdir)
...
LOG_FILE_SUBDIR="/mnt/vault/cloud/logs/${SRC_DIR_NAME}_logs"   # Directory for run logs
